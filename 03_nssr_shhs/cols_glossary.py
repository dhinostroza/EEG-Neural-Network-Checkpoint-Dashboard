...
GLOSSARY_TERMS = [
    ...
    {"es": "Clasificación de las etapas de sueño", "en": "Sleep Stage Classification", "desc": "Proceso de asignar una etiqueta (N1, N2, N3, REM, Wake) a una época de sueño basada en señales fisiológicas."},
    ...
    {"es": "Cargador de Ddatos", "en": "DataLoader", "desc": "Utilidad de PyTorch que maneja la carga eficiente de datos en lotes (minibatches) y el barajado (shuffling)."},
